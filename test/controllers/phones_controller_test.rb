...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { numbre_phone: @phone.numbre_phone, user_id: @phone.user_id } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { numbre_phone: @phone.numbre_phone, user_id: @phone.user_id } }
