...
class EmailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email" do
    assert_difference('Email.count') do
      post emails_url, params: { email: { emailtxt: @email.emailtxt, user_id: @email.user_id } }
    end
  ...
  test "should update email" do
    patch email_url(@email), params: { email: { emailtxt: @email.emailtxt, user_id: @email.user_id } }
